...
class CycleGAN(object):
    ...
    def build_model(self):
        ...
        self.lambda_cycle = tf.compat.v1.placeholder(tf.float32, shape=[], name='lambda_cycle')
        self.lambda_identity = tf.compat.v1.placeholder(tf.float32, shape=[], name='lambda_identity')
    ...
    def optimizer_initializer(self):
        ...
        self.generator_learning_rate = v1.placeholder(tf.float32, None, name = 'generator_learning_rate')
        self.discriminator_learning_rate = v1.placeholder(tf.float32, None, name = 'discriminator_learning_rate')
    ...
    def summary(self):
        with tf.name_scope('generator_summaries'):
            ...
            generator_summaries = v1.summary.merge_all([cycle_loss_summary, identity_loss_summary, generator_loss_A2B_summary, generator_loss_B2A_summary, generator_loss_summary])
        ...
        with tf.name_scope('discriminator_summaries'):
            ...
            discriminator_summaries = v1.summary.merge_all([discriminator_loss_A_summary, discriminator_loss_B_summary, discriminator_loss_summary])
